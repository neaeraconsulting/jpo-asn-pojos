...
public class RTCMcorrectionsMessageFrameSchemaTest {
  @Test
  void testRTCMcorrectionsMessageFrameJsonAgainstSchema() throws Exception {
    // Load JSON instance
    String jsonPath = "src/test/resources/us/dot/its/jpo/asn/jsonschema/generator/RTCMcorrections/rtcm_mf.json";
    String jsonData = new String(Files.readAllBytes(Paths.get(jsonPath)), StandardCharsets.UTF_8);

    // Load JSON schema
    String schemaPath = "src/main/resources/schemas/RTCMcorrections/RTCMcorrectionsMessageFrame.schema.json";
