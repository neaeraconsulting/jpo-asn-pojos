...
public class MapDataMessageFrameSchemaTest {
  @Test
  void testMapDataMessageFrameJsonAgainstSchema() throws Exception {
    // Load JSON instance
    String jsonPath = "src/test/resources/us/dot/its/jpo/asn/jsonschema/generator/MapData/map_mf.json";
    String jsonData = new String(Files.readAllBytes(Paths.get(jsonPath)), StandardCharsets.UTF_8);

    // Load JSON schema
    String schemaPath = "src/main/resources/schemas/MapData/MapDataMessageFrame.schema.json";
