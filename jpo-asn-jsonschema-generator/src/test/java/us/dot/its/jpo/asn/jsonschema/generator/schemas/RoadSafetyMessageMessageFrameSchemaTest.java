...
public class RoadSafetyMessageMessageFrameSchemaTest {
  @Test
  void testRoadSafetyMessageMessageFrameJsonAgainstSchema() throws Exception {
    // Load JSON instance
    String jsonPath = "src/test/resources/us/dot/its/jpo/asn/jsonschema/generator/RoadSafetyMessage/rsm_mf.json";
    String jsonData = new String(Files.readAllBytes(Paths.get(jsonPath)), StandardCharsets.UTF_8);

    // Load JSON schema
    String schemaPath = "src/main/resources/schemas/RoadSafetyMessage/RoadSafetyMessageMessageFrame.schema.json";
