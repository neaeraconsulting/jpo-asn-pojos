...
public class BasicSafetyMessageMessageFrameSchemaTest {
  @Test
  void testBasicSafetyMessageMessageFrameJsonAgainstSchema() throws Exception {
    // Load JSON instance
    String jsonPath = "src/test/resources/us/dot/its/jpo/asn/jsonschema/generator/BasicSafetyMessage/bsm_mf.json";
    String jsonData = new String(Files.readAllBytes(Paths.get(jsonPath)), StandardCharsets.UTF_8);

    // Load JSON schema
    String schemaPath = "src/main/resources/schemas/BasicSafetyMessage/BasicSafetyMessageMessageFrame.schema.json";
