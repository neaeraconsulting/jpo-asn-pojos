...
public class TravelerInformationMessageFrameSchemaTest {
  @Test
  void testTravelerInformationMessageFrameJsonAgainstSchema() throws Exception {
    // Load JSON instance
    String jsonPath = "src/test/resources/us/dot/its/jpo/asn/jsonschema/generator/TravelerInformation/tim_mf.json";
    String jsonData = new String(Files.readAllBytes(Paths.get(jsonPath)), StandardCharsets.UTF_8);

    // Load JSON schema
    String schemaPath = "src/main/resources/schemas/TravelerInformation/TravelerInformationMessageFrame.schema.json";
